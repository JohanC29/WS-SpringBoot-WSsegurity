 ...
 * 2022-10-19T10:16:53.967-05:00
 * Generated source version: 3.3.0
 *
 */
@WebServiceClient(name = "SumService",
                  wsdlLocation = "file:/D:/LocalD_JC/09.Laboratorio/demo8/src/main/resources/wsdl/SumService.wsdl",
                  targetNamespace = "http://localhost/SumService/wsdl")
public class SumService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://localhost/SumService/wsdl", "SumService");
    public final static QName SumServiceSOAPBinding = new QName("http://localhost/SumService/wsdl", "SumServiceSOAPBinding");
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/LocalD_JC/09.Laboratorio/demo8/src/main/resources/wsdl/SumService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SumService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/LocalD_JC/09.Laboratorio/demo8/src/main/resources/wsdl/SumService.wsdl");
        }
        WSDL_LOCATION = url;
    }
